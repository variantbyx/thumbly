    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8 transition duration-500">
          <Link to="/" className="hover:pink-text-300 transition">
            {" "}
            Home
          </Link>
          <Link to="/generate" className="hover:pink-text-300 transition">
            {" "}
            Generate
          </Link>
          <Link to="/my-generation" className="hover:pink-text-300 transition">
            {" "}
            My Generations
          </Link>
          <Link to="#" className="hover:pink-text-300 transition">
